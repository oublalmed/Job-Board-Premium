...
| **Lot 6** | Abonnement & facturation (PSP, paliers, dunning) | Lot 4 | 🟨 En cours | 2026-07-30 | 6A ✅ : index unique partiel `subscriptions` (dette Lot 5A refermée en base) + lifecycle de statuts avec transitions gardées. ⚠️ Confirmer le PSP (compatible Maroc, ICE/TVA) avant 6B |
...
- [ ] **6B** — intégration PSP (fournisseur à confirmer, compatible Maroc/ICE/TVA), webhooks de paiement, factures
